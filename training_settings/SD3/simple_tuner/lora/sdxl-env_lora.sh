...
export VALIDATION_PROMPT="a bust up view of a woman with brown eyes and long wavy brown hair, wearing a white dress with exposed neckline, looking at viewer with a neutral expression, wearing silver earrings, exposed forehead, light gray background"
